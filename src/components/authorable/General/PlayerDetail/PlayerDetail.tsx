...
let objectDate = new Date(fields.Dob?.value);
  return (
    <div
    ...
    >
      ...
      <div>
        <div className='flex space-x-2 md:space-x-8 col-span-2 w-2/12 mb-6'>
          <button id='btn1' className='rounded-lg px-4 py-2 bg-gray-500 text-white hover:bg-gray-600 duration-300' onClick={() => btnClick(1)}>Biography</button>
          <button id='btn2' className='rounded-lg px-4 py-2 bg-gray-500 text-white hover:bg-gray-600 duration-300' onClick={() => btnClick(2)}>Statistics</button>        
        </div>
        <div className={`space-y-3 tabContent hidden ${manageClass(1,'!block')}`}>
          ...
          <div className='flex space-x-5'>
            ...
            <div className=''>{objectDate.getDate() + '/' + objectDate.getMonth() + '/' + objectDate.getFullYear()}</div>
          </div>
          <div className='flex space-x-5'>
        ...
        <h2 className='font-bold mb-3'>Batting and Fielding</h2>
          ...
          <table className='w-full border-black border-solid border-1'>
            <tr className='text-left'>
              ...
              <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Runs</th>
              <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Highest Score</th>
              <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Total Sixes</th>
              <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Total Fours</th>
              <th className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">100s</th>
            ...
            <tr className='text-left'>
              ...
              <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">{fields.TotalRunsScored.value}</td>
              <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">{fields.HighestScore.value}</td>
              <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">{fields.TotalSixes.value}</td>
              <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">{fields.TotalFours.value}</td>
              <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">{fields.HundredsInNumber.value}</td>
